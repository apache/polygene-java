...
public class EntityViewer
{
    ...
    public void show( Energy4Java qi4j, Application application )
    {
        this.qi4j = qi4j;
    ...
    private void initUI()
    {
        ...
        treePanel.initializeQi4J( qi4j, application );
        treePanel.reload();
    ...
    protected Query createQuery( Module module, Class clazz )
    {
        ...
        QueryBuilder qb = uow.queryBuilderFactory().newQueryBuilder( clazz );
