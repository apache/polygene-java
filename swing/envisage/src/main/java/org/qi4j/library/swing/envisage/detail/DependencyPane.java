...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$()
    {
        ...
        this.$$$loadLabelText$$$( label4, ResourceBundle.getBundle( "org/qi4j/library/swing/envisage/detail/DependencyPane" ).getString( "CTL_InjectionType.Text" ) );
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 10;
        gbc.anchor = GridBagConstraints.EAST;
        ...
        this.$$$loadLabelText$$$( label5, ResourceBundle.getBundle( "org/qi4j/library/swing/envisage/detail/DependencyPane" ).getString( "CTL_Injection.Text" ) );
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 8;
        gbc.anchor = GridBagConstraints.WEST;
        ...
        this.$$$loadLabelText$$$( label6, ResourceBundle.getBundle( "org/qi4j/library/swing/envisage/detail/DependencyPane" ).getString( "CTL_InjectedServices.Text" ) );
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 12;
