 ...
 */
public class ImportedByPane extends DetailPane
{
    private JPanel contentPane;
    private JLabel nameLabel;
    private JLabel classLabel;

    public ImportedByPane( DetailModelPane detailModelPane )
    {
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$()
    {
        ...
        this.$$$loadLabelText$$$( label1, ResourceBundle.getBundle( "org/qi4j/library/swing/envisage/detail/ImportedByPane" ).getString( "CTL_Name.Text" ) );
        ...
        this.$$$loadLabelText$$$( label2, ResourceBundle.getBundle( "org/qi4j/library/swing/envisage/detail/ImportedByPane" ).getString( "CTL_Class.Text" ) );
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 3;
        gbc.anchor = GridBagConstraints.WEST;
