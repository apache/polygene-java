        ...
        implements School
    {
        ...
        public final Query<Subject> availableSubjects()
        {
            ...
            try
            {
                ...
                builder.where( org.qi4j.api.query.QueryExpressions.eq( subject.schoolId(), schoolId.idString() ) );
        ...
        public final Query<Student> students()
        {
            ...
            try
            {
                ...
                builder.where( org.qi4j.api.query.QueryExpressions.eq( studentState.schoolId(), schoolId.idString() ) );
