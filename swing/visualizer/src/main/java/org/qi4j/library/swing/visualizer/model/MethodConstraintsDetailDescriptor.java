...
public final class MethodConstraintsDetailDescriptor
{
    ...
    private final List<ConstraintDetailDescriptor> constraints;
        ...
        throws IllegalArgumentException
    {
        ...
        constraints = new LinkedList<ConstraintDetailDescriptor>();
    }
     ...
     * @since 0.5
     */
    public final Iterable<ConstraintDetailDescriptor> constraints()
    {
        return constraints;
    }
    ...
    final void addConstraint( ConstraintDetailDescriptor aDescriptor )
    {
        validateNotNull( "aDescriptor", aDescriptor );
