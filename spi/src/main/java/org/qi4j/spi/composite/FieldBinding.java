...
{
    private FieldResolution fieldResolution;
    private InjectionBinding injectionBinding;

    public FieldBinding( FieldResolution fieldResolution, InjectionBinding injectionBinding )
    {
        this.fieldResolution = fieldResolution;
        this.injectionBinding = injectionBinding;
    }

    public FieldResolution getFieldResolution()
    {
