    ...
    implements AlarmModelProvider
{
    ...
    static String MODEL_BUNDLE_NAME = "org.qi4j.library.alarm.providers.standard.AlarmResources";

    private final String[] ALARM_TRIGGERS =
        {
            Alarm.TRIGGER_ACTIVATION, Alarm.TRIGGER_DEACTIVATION, Alarm.TRIGGER_ACKNOWLEDGE
        };
    ...
    static ResourceBundle getResourceBundle( Locale locale )
    {
        ...
        ClassLoader cl = StandardModelProvider.class.getClassLoader();
