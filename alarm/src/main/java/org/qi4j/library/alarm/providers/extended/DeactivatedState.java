...
/**
 * Implements the Alarm state of an deactivated standard.
 */

public final class DeactivatedState
    implements AlarmState, java.io.Serializable
{
    ...
    public String toString()
    {
        ...
        String pattern = rb.getString( "STATE_DEACTIVATED_TOSTRING" );
    ...
    public String getName( Locale locale )
    {
        ...
        return rb.getString( "STATE_DEACTIVATED_NAME" );
    }
    ...
    {
        ResourceBundle rb = ExtendedModelProvider.getResourceBundle( locale );
        return rb.getString( "STATE_DEACTIVATED_DESCRIPTION" );
    }
}
