...
/**
 * AlarmState Normal in the Standard Alarm Extension.
 * Implements the Alarm state behaviour of a normal standard, the Standard
 * standard events are invoked upon.
 */
    ...
    implements AlarmState, java.io.Serializable
{
    ...
    public String getName( Locale locale )
    {
        ...
        return rb.getString( "STATE_NORMAL_NAME" );
    }
    ...
    {
        ResourceBundle rb = ExtendedModelProvider.getResourceBundle( locale );
        return rb.getString( "STATE_NORMAL_DESCRIPTION" );
    }
}
