...
public final class ReactivationEvent extends GenericAlarmEvent
{

    private static final long serialVersionUID = 2L;

    public ReactivationEvent( Object triggedBy, Alarm alarm,
    ...
    public String toString()
    {
        ...
        String pattern = rb.getString( "EVENT_REACTIVATION_TOSTRING" );
