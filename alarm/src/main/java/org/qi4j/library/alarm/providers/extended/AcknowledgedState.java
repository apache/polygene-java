...
public final class AcknowledgedState
    implements AlarmState, java.io.Serializable
{
    ...
    public String toString()
    {
        ...
        String pattern = rb.getString( "STATE_ACKNOWLEDGED_TOSTRING" );
    ...
    public String getName( Locale locale )
    {
        ...
        return rb.getString( "STATE_ACKNOWLEDGED_NAME" );
    }
    ...
    {
        ResourceBundle rb = ExtendedModelProvider.getResourceBundle( locale );
        return rb.getString( "STATE_ACKNOWLEDGED_DESCRIPTION" );
    }
}
