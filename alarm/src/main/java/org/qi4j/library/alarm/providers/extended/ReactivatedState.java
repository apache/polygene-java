...
public final class ReactivatedState
    implements AlarmState, java.io.Serializable
{
    ...
    public String toString()
    {
        ...
        String pattern = rb.getString( "STATE_REACTIVATED_TOSTRING" );
    ...
    public String getName( Locale locale )
    {
        ...
        return rb.getString( "STATE_REACTIVATED_NAME" );
    }
    ...
    {
        ResourceBundle rb = ExtendedModelProvider.getResourceBundle( locale );
        return rb.getString( "STATE_REACTIVATED_DESCRIPTION" );
    }
}
