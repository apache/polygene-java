...
public final class DisableEvent extends GenericAlarmEvent
{

    static final long serialVersionUID = 2L;

    public DisableEvent( Object triggedBy, Alarm alarm,
    ...
    public String toString()
    {
        ...
        String pattern = rb.getString( "EVENT_DISABLE_TOSTRING" );
