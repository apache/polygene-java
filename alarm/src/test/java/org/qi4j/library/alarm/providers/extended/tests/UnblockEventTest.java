...
public class UnblockEventTest extends TestCase
{
    ...
    public void testName()
        throws Exception
    {
        AlarmEvent e = new UnblockEvent( this, m_Alarm, null, null, System.currentTimeMillis() );
    ...
    {
        GenericAlarmEvent e = new UnblockEvent( this, m_Alarm, null, null, System.currentTimeMillis() );
