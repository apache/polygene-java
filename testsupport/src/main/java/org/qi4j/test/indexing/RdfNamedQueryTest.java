...
public abstract class RdfNamedQueryTest
{
    ...
    public void setUp() throws UnitOfWorkCompletionException
    {
        assembler = new SingletonAssembler()
        {
            ...
            private void addQuery( NamedQueries namedQueries, int index )
            {
                ...
                NamedQueryDescriptor descriptor = createNamedQueryDescriptor( queryName, queryString );
    ...
    protected abstract void setupTest( NamedQueries namedQueries )
        throws AssemblyException;
