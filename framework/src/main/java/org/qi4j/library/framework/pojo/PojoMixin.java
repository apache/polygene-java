...
@AppliesTo( { PojoMixin.PojoBackedFilter.class } )
public class PojoMixin
    implements PojoBacked, InvocationHandler
{
    @Structure CompositeBuilderFactory factory;
    private HashMap<Method, Property> properties;
    private Object pojo;

    public PojoMixin( @This Composite thisComposite, @Uses Object pojo )
    {
        this.pojo = pojo;
    ...
    public void setPojo( Object data )
    {
        pojo = data;
    }
        ...
        implements AppliesToFilter
    {
        public boolean appliesTo( Method method, Class<?> mixin, Class<?> compositeType, Class<?> modifierClass )
        {
            ...
            return Property.class.isAssignableFrom( method.getReturnType() ) ||
                   "getPojo".equals( methodName ) || "setPojo".equals( methodName );
        }
    }
