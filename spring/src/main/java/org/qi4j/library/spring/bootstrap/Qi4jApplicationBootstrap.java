 ...
 * <li>Sets the identity of bean factory service. This identity is the spring bean name.</li>
...
public abstract class Qi4jApplicationBootstrap
{
     ...
     *
     * @param applicationAssembly qi4j application assembly. Must not be {@code null}.
     * @throws AssemblyException Thrown if assemblies fails.
     */
