...
/**
 * Interface used to query for ServiceReferences. Each ServiceLocator is
...
{
    /**
     * Lookup a ServiceReference that implements the given type.
     *
     ...
     */
    <T> ServiceReference<T> lookupService( Class<T> serviceType );

    /**
     * Lookup ServiceReferences that implements the given type.
     * <p/>
     ...
     */
    <T> Iterable<ServiceReference<T>> lookupServices( Class<T> serviceType );
}
