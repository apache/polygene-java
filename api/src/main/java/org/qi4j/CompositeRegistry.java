...
/**
 * CompositeRegistries are responsible for mapping interfaces,
 ...
 * Class<? extends User> userComposite = registry.getCompositeType
 */
public interface CompositeRegistry
    extends CompositeMapper
{
    Class<? extends Composite> getCompositeType( Class domainInterfaces );
}
