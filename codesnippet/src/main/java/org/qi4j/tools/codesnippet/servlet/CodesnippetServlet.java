 ...
 */
public final class CodesnippetServlet extends HttpServlet
{
     ...
     * 
     * @throws TransformerConfigurationException when parsing to construct the Templates object fails
     ...
     */
    private void transform( String encoding, URL javaSource, String snippetId, String outputId, PrintWriter output, Templates templates )
        throws TransformerFactoryConfigurationError,
        ServletException,
