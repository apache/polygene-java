...
public class SpatialFunctionsSupportMatrix
{
    ...
    private static final Table<String, INDEX_MAPPING_TPOINT_METHOD, ConfigurationEntry> SPATIAL_SUPPORT_MATRIX = HashBasedTable.create();
    ...
    {
        private INDEX_MAPPING_TPOINT_METHOD method;
        ...
        public ConfigurationEntry(Class<? extends  TGeometry>[] geometriesOfProperty, Class<? extends  TGeometry>[] geometriesOfFilter, Boolean orderBy, INDEX_MAPPING_TPOINT_METHOD method)
        {
    ...
    public static boolean isSupported(Class expression, Class<? extends  TGeometry> geometryOfProperty,Class<? extends  TGeometry> geometryOfFilter, Boolean orderBy, INDEX_MAPPING_TPOINT_METHOD method )
    {
    ...
    public static boolean isSupported(Class expression, Class<? extends  TGeometry> geometryOfProperty,Class<? extends  TGeometry> geometryOfFilter, INDEX_MAPPING_TPOINT_METHOD method )
    {
        return isSupported(expression, geometryOfProperty, geometryOfFilter, false, method);
    }

    private static void supports (Class expression, Class<? extends  TGeometry> geometryOfProperty,Class<? extends  TGeometry> geometryOfFilter, Boolean orderBy, INDEX_MAPPING_TPOINT_METHOD method)
    {
        supports
                (
                 expression,
    ...
    private static void supports (Class expression, Class<? extends  TGeometry>[] geometriesOfProperty,Class<? extends  TGeometry>[] geometriesOfFilter, Boolean orderBy, INDEX_MAPPING_TPOINT_METHOD method)
    {
