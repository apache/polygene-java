 ...
 */
public class ST_WithinOperationBackup implements ElasticSearchSpatialPredicateFinderSupport.PredicateSpecification {
            ...
            throws EntityFinderException
    {
        ...
        if (spec.operator() != null) {
            try {
                ...
                {
                   // ElasticSearchSpatialFinderSupport.processSpecification(filterBuilder,  spec.operator(), variables);
                }
        ...
        if (spec instanceof  SpatialPredicatesSpecification)
        {
            ...
            else if (((SpatialPredicatesSpecification)spec).operator() != null)
            {
                ...
                if (((SpatialPredicatesSpecification) spec).operator() instanceof SpatialConvertSpecification)
                {
                   ...
                   //  new ElasticSearchSpatialConvertFinderSupport().processSpecification();
