        ...
        extends AbstractSQLEntityStoreAssembler
{
    ...
    public static final String ENTITYSTORE_SERVICE_NAME = "entitystore-h2";

    public H2SQLEntityStoreAssembler( DataSourceAssembler assembler )
    {
        super( assembler );
    }

    public H2SQLEntityStoreAssembler( Visibility visibility, DataSourceAssembler assembler )
    {
