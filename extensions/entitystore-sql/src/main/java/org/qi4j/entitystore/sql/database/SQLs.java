...
public interface SQLs
{
    ...
    String SELECT_ALL_ENTITIES_SQL = "SELECT " + ENTITY_PK_COLUMN_NAME + ", " + ENTITY_STATE_COLUMN_NAME + " FROM %s." + TABLE_NAME;

    String SELECT_ENTITY_SQL = SELECT_ALL_ENTITIES_SQL + " WHERE " + ENTITY_IDENTITY_COLUMN_NAME + " = ?";

    String INSERT_ENTITY_SQL = "INSERT INTO %s." + TABLE_NAME + " VALUES(?, ?, ?)";

    String UPDATE_ENTITY_SQL = "UPDATE %s." + TABLE_NAME + " SET " + ENTITY_STATE_COLUMN_NAME + " = ? WHERE " + ENTITY_PK_COLUMN_NAME + " = ?";
