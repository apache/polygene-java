...
public interface SQLs
{
    ...
    String UPDATE_ENTITY_SQL = "UPDATE %s." + TABLE_NAME + " SET " + ENTITY_OPTIMISTIC_LOCK_COLUMN_NAME + " = ?, " + ENTITY_STATE_COLUMN_NAME + " = ?, " + ENTITY_LAST_MODIFIED_COLUMN_NAME + " = ? WHERE " + ENTITY_PK_COLUMN_NAME + " = ? AND " + ENTITY_OPTIMISTIC_LOCK_COLUMN_NAME + " = ?";
