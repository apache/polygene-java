 ...
 //   implements EntityStore, Activatable
{
        ...
        throws EntityStoreException
    {
        ...
        return null; // new LegacyEntityState( type, identity, new HashMap<QualifiedName, Object>(), 0L, System.currentTimeMillis(), NEW );
    }
        ...
        throws EntityStoreException
    {
        ...
        return null; //new LegacyEntityState( getEntityType( anIdentity ), anIdentity, rawData, version, lastModified, LOADED );
    }
