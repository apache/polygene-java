...
//        entityStore.iterator();
    ...
    @Test
    public final void createNewEntityStateWithoutPersisting()
    ...
    @Test
    public final void completeThrowsNPE() throws UnitOfWorkCompletionException
    {
        final UnitOfWork uow = unitOfWorkFactory.newUnitOfWork();
...
/*
        assertEquals( "ACCOUNTS", state.manyAssociationTypes().iterator().next() );
...
*/
    ...
    private EntityReference createId(String id, Class<?> compositeClass)
    {
        return new EntityReference(id);
    }

    @Test
    public void findExistingPersonComposite() throws UnitOfWorkCompletionException
    {
        final UnitOfWork uow = unitOfWorkFactory.newUnitOfWork();
    ...
    {
        final EntityReference entityReference = id(id);
        return this.entityStore.getEntityState(entityReference);
    }
