...
import static org.qi4j.service.ServiceSelector.*;
...
public class ServiceIdSelectorTest
{
    ...
    public void givenManyServicesWhenInjectServiceThenGetSelectedOne()
    {
        ...
        ObjectBuilderFactory obf = assembler.getObjectBuilderFactory();
        ServiceConsumer consumer = obf.newObjectBuilder( ServiceConsumer.class ).use( TestServiceComposite2.class.getSimpleName() ).newInstance();
    ...
    public static class ServiceConsumer
    {
        ...
        {
            service = new ServiceSelector<TestService>( serviceRefs, id( serviceId ) ).get();
        }
