    ...
    implements ApplicationModelFactory
{
        ...
        throws AssemblyException
    {
        ...
        ApplicationModel applicationModel = new ApplicationModel( applicationAssembly.name(), applicationAssembly.mode(), applicationAssembly.metaInfo(), layerModels, applicationAssembly.getMigration() );
