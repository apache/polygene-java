 ...
 * TODO
 */
public class SideEffectsInstance
{
    ...
    public SideEffectsInstance( Method method, List<InvocationHandler> sideEffects, SideEffectInvocationHandlerResult resultInvocationHandler, ProxyReferenceInvocationHandler proxyHandler )
    {
        this.method = method;
