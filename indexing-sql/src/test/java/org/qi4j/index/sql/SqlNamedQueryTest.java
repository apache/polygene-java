    ...
    private static String[] query =
        {
            ...
            "PREFIX sql: <http://www.w3.org/1999/02/22-sql-syntax-ns#> \n" +
            "PREFIX rdfs: <http://www.w3.org/2000/01/sql-schema#> \n" +
            "SELECT DISTINCT ?entityType ?identity\n" +
            "WHERE {\n" +
            "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.index.sql.model.Person>. \n" +
            "?entity sql:type ?entityType. \n" +
            "?entity ns0:identity ?identity. \n" +
            "\n" +
            "}", //script01

            "PREFIX ns1: <urn:qi4j:type:org.qi4j.index.sql.model.Nameable#> \n" +
            "PREFIX ns0: <urn:qi4j:type:org.qi4j.api.entity.Identity#> \n" +
            "PREFIX sql: <http://www.w3.org/1999/02/22-sql-syntax-ns#> \n" +
            "PREFIX rdfs: <http://www.w3.org/2000/01/sql-schema#> \n" +
            "SELECT DISTINCT ?entityType ?identity\n" +
            "WHERE {\n" +
            "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.index.sql.model.Domain>. \n" +
            "?entity sql:type ?entityType. \n" +
            "?entity ns0:identity ?identity. \n" +
            "?entity ns1:name ?v0. \n" +
            "FILTER (?v0 = \"Gaming\")\n" +
            ...
            "SELECT DISTINCT ?entityType ?identity\n" +
            "WHERE {\n" +
            "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.index.sql.model.Nameable>. \n" +
            "?entity sql:type ?entityType. \n" +
            "?entity ns0:identity ?identity. \n" +
            "\n" +
            "}", //script03

            "PREFIX ns1: <urn:qi4j:type:org.qi4j.index.sql.model.Person#> \n" +
            "PREFIX ns2: <urn:qi4j:type:org.qi4j.index.sql.model.Nameable#> \n" +
            "PREFIX ns0: <urn:qi4j:type:org.qi4j.api.entity.Identity#> \n" +
            "PREFIX sql: <http://www.w3.org/1999/02/22-sql-syntax-ns#> \n" +
            "PREFIX rdfs: <http://www.w3.org/2000/01/sql-schema#> \n" +
            "SELECT DISTINCT ?entityType ?identity\n" +
            ...
            "SELECT DISTINCT ?entityType ?identity\n" +
            "WHERE {\n" +
            "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.index.sql.model.Female>. \n" +
            "?entity sql:type ?entityType. \n" +
            "?entity ns0:identity ?identity. \n" +
            "?entity ns1:yearOfBirth ?v0. \n" +
            "FILTER ((?v0 = \"1970\") || (?v0 = \"1975\"))\n" +
            ...
            "PREFIX ns0: <urn:qi4j:type:org.qi4j.api.entity.Identity#> \n" +
            "PREFIX sql: <http://www.w3.org/1999/02/22-sql-syntax-ns#> \n" +
            "PREFIX ns1: <urn:qi4j:type:org.qi4j.index.sql.model.Male#> \n" +
            "PREFIX rdfs: <http://www.w3.org/2000/01/sql-schema#> \n" +
            "SELECT DISTINCT ?entityType ?identity\n" +
            "WHERE {\n" +
            "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.index.sql.model.Person>. \n" +
            ...
            "SELECT DISTINCT ?entityType ?identity\n" +
            "WHERE {\n" +
            "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.index.sql.model.Male>. \n" +
            "?entity sql:type ?entityType. \n" +
            "?entity ns0:identity ?identity. \n" +
            "OPTIONAL {?entity ns1:wife ?v0}. \n" +
            "FILTER (! bound(?v0))\n" +
