...
package org.apache.polygene.tools.shell.create.project.defaultp;
...
public class ApplicationWriter
{
        ...
        throws IOException
    {
        ...
        try (PrintWriter pw = createPrinter( properties ))
        {
            ...
            pw.println( "import org.apache.polygene.bootstrap.Energy4Java;" );
            pw.println( "import org.apache.polygene.bootstrap.layered.LayeredApplicationAssembler;" );
            pw.println( "import org.apache.polygene.library.restlet.ZrestApplication;" );
            ...
            pw.println( "{\n" );
            pw.println( "    private static Energy4Java polygene;" );
            ...
            pw.println( "    {" );
            pw.println( "        polygene = new Energy4Java();" );
            pw.println( format("        app = polygene.newApplication( new %sApplicationAssembler() );", projectName) );
