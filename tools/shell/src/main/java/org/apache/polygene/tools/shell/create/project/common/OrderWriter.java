...
public class OrderWriter
{
        ...
        throws IOException
    {
        ...
        try (PrintWriter pw = createPrinter( properties ))
        {
            ...
            pw.println("import org.apache.polygene.api.association.Association;");
            pw.println("import org.apache.polygene.api.association.ManyAssociation;");
            pw.println("import org.apache.polygene.api.common.Optional;");
