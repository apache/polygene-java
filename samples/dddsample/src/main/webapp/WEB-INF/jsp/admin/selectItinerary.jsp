        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img alt=""
                         src="<c:url value="/images/calendarTrigger.gif"/>"
                         class="calendarTrigger"
                         onclick="calendar.toggle( event, this, 'cal1')"/>
                </td>
            </tr>
        </table>
        <p>
        ...
        <form action="${postUrl}" method="post">
            ...
            <table>
                ...
                <c:forEach items="${it.legs}" var="leg" varStatus="legStatus">
                    <input type="hidden"
                           name="legs[${legStatus.index}].carrierMovementId"
                           value="${leg.carrierMovementId}"/>
