                     ...
                     try
                     {
                        ...
                        for (Row rowValue : tableValue.rows().get())
                        {
                           ...
                           for (Cell cellValue : rowValue.c().get())
                           {
                              ...
                              if (columnList.get( idx ).columnType().get().equals(Table.DATETIME) && value != null)
                              {
                                 value = Dates.toUtcString( (Date) value );
                              }
                              else if (columnList.get( idx ).columnType().get().equals(Table.DATE) && value != null)
                              {
                                 value = new SimpleDateFormat( "yyyy-MM-dd").format( (Date) value);
                              }
                              else if (columnList.get( idx ).columnType().get().equals(Table.TIME_OF_DAY) && value != null)
                              {
