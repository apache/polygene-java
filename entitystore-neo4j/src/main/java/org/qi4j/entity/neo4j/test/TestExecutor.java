...
public abstract class TestExecutor
{
    ...
    protected <T extends EntityComposite> CompositeBuilder<T> newEntityBuilder( Class<T> compositeType )
    {
        return uow.newEntityBuilder( compositeType );
    }

    protected <T extends EntityComposite> CompositeBuilder<T> newEntityBuilder( String identity, Class<T> compositeType )
    {
